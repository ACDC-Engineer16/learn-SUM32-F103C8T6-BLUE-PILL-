...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
volatile uint32_t counter = 0,last_count = 0;
char buf[30];
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : E_COUNTER_Pin */
  GPIO_InitStruct.Pin = E_COUNTER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(E_COUNTER_GPIO_Port, &GPIO_InitStruct);
